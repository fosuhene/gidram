    ...
    <script type="text/javascript">
        Highcharts.chart('chartinfo', {
            ...
            series: [{
                name: '',
                data: [
                        ['Community Offices No', <?php echo ($locations);?>],
...
Highcharts.chart('venndiagram', {
    series: [{
        ...
        data: [{
            ...
            sets: ['Community offices', 'Facilities'],
            value: 1,
            name: ' Community connected to facilities '
        }, {
            sets: ['Community offices', 'Tax companies'],
            value: 1,
            ...
            sets: ['Community offices', 'Tax companies', 'Facilities'],
            value: 1,
            name: 'Tax'
        }]
    }],
...
Highcharts.chart('levels', {
    series: [{
        ...
        data: [{
            id: 'A',
            name: 'Community Office - Community(<?php echo ($community);?>)',
            color: "#1ABB9C"
        }, {
            id: 'B',
            name: 'Facilities',
  ...
  <?php
    ...
    foreach($transaction as $result){
        // for ($i=0; $i < count($report); $i++) {
            # code...
        $FacilityName[] =  $result->FC_CommunityName;  //ambil bulan
