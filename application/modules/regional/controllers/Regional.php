...
public function  __construct(){
  ...
  public function regionalindex($id=Null){
    ...
    $data['reports'] = $this->regional->taxgrade_chart();
    $data['location'] = $this->regional->location_chart();
    $data['venn'] = $this->regional->location_chart();
    $data['orglevel'] = $this->regional->levels_chart();
    $data['year'] = $this->regional->get_year();
    $data['transaction'] = $this->regional->get_transactions();
