    ...
    <script type="text/javascript">
        Highcharts.chart('chartinfo', {
            ...
            series: [{
                name: '',
                data: [
                        ['Regional Offices No', <?php echo ($locations);?>],
...
Highcharts.chart('venndiagram', {
    series: [{
        ...
        data: [{
            ...
            sets: ['Regional offices', 'Facilities'],
            value: 1,
            name: ' Regional connected to facilities '
        }, {
            sets: ['Regional offices', 'Tax companies'],
            value: 1,
            ...
            sets: ['Regional offices', 'Tax companies', 'Facilities'],
            value: 1,
            name: 'Tax'
        }]
    }],
...
Highcharts.chart('levels', {
    series: [{
        ...
        data: [{
            id: 'A',
            name: 'Regional Office - Regional(<?php echo ($regional);?>)',
            color: "#1ABB9C"
        }, {
            id: 'B',
            name: 'Districts',
