                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"  ng-app="">
                                       <!--  <h6><strong> Account Info</strong></h6> -->
                                        ...
                                        <?php echo form_open('Regional/regional'); ?>
                                    ...
                                    <div class="card-body"  ng-app="">
                                       <!--  <h6><strong> Account Info</strong></h6> -->
                                        ...
                                        <br/>
                                         ...
                                         <input type="hidden" class="form-control" name="hierachyNationalID" value=" <?php echo $user_info->user_id?>
">
