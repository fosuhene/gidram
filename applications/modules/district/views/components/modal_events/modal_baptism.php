                               ...
                               <!--  <h5 class="">Offering Details</h5> -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                       <form id="baptismform"  method="post">
                                         <div class="form-row ">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <label for="inputEmail4" class="col-form-label">Hometown</label>
                                              <?php echo form_input(['type' => 'text', 'name' => 'hometown', 'id' => 'hometown', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                            </div>
                                          </div>
                                         <div class="form-row">
                                            <div class="form-group col-md-6">
                                ...
                                <div class="card-body" >
                                  <div class="form-row">
                                      <div class="form-group col-md-6">
                                        ...
                                        <?php echo form_input(['type' => 'text', 'name' => 'fathers_nationality', 'id' => 'fathers_nationality', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                      </div>
                                      <div class="form-group col-md-6">
                                      <label for="inputEmail4" class="col-form-label">Mother's Nationality</label>
                                        <?php echo form_input(['type' => 'text', 'name' => 'mothers_nationality', 'id' => 'mothers_nationality', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        ...
                                        <?php echo form_input(['type' => 'date', 'name' => 'Baptism Date', 'id' => 'baptism_date', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                      </div>
                                      <div class="form-group col-md-6">
                                      <label for="inputEmail4" class="col-form-label">Baptism Place</label>
                                        <?php echo form_input(['type' => 'text', 'name' => 'baptism_place', 'id' => 'baptism_place', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                      </div>
                                    </div>
