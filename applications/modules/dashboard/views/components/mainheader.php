      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          ...
          <li><a href="<?php echo base_url(); ?>/Regional/regionalindex"><i class="fa fa-cubes"></i> Regionals <!-- <span class="fa fa-chevron-down"></span> --></a>
				  ...
				  <li><a href="<?php echo base_url(); ?>/Facility/facilityindex"><i class="fa fa-book"></i> Facilities<!--  <span class="fa fa-chevron-down"></span> --></a>
           </li>
          <li><a href="<?php echo base_url(); ?>/Businesses/businessindex"><i class="fa fa-book"></i> Businesses<!--  <span class="fa fa-chevron-down"></span> --></a>
             </li>
          <!-- ################### Bottom Menus###################################################################### -->
           </ul>
              </div>
              <div class="menu_section">
               ...
               <li><a href="<?php echo base_url(); ?>/Dashboard/new_profile"><i class="fa fa-user"></i>PROFILE <!-- <span class="fa fa-chevron-down"></span> --></a>
            </li>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-cog"></i> SETUPS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="project_detail.html">Communities</a></li>
                      <li><a href="contacts.html">Facilities</a></li>
                      <li><a href="profile.html">Location</a></li>
                    </ul>
                  </li>
               <li><a href="<?php echo base_url(); ?>/Dashboard/new_profile"><i class="fa fa-user"></i>PROFILE <!-- <span class="fa fa-chevron-down"></span> --></a>
            </li>
