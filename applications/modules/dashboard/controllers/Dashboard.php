...
//$data['menu'] = $this->pages_model->call_menu();
 ...
 public function index(){
	...
	$data['report'] = $this->cread->report();
	$data['reports'] = $this->cread->reports();
  ...
  public function charts(){
    ...
    $data['report'] = $this->cread->reportstats();
    $data['subview'] = 'dashboard/charts';
    $this->load->view('dashboard/charts', $data);
 }
 
 
 public function testjsdata(){
    if ($this->ion_auth->logged_in()){
    $data['user_info'] =$this->ion_auth->user()->row();
	$data['report'] = $this->cread->report();
    $data['subview'] = 'dashboard/localconf';
    $this->load->view('dashboard/localconf', $data);
   }
 }

public function gidchart(){
    if ($this->ion_auth->logged_in()){
    $data['user_info'] =$this->ion_auth->user()->row();
	$data['report'] = $this->cread->report();
    $data['subview'] = 'dashboard/mychart';
    $this->load->view('dashboard/mychart', $data);
   }
 }
