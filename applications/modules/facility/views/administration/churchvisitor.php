...
<!-- ############### Add Membership Details Page ################################################ -->
 <!-- Main Content Area -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card card-body">
                                                    <h5 class="">Church Visitor Details</h5>
                                                    <p> Please fill in the  form. Thank you.</p>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <?php echo validation_errors(); ?>
                                                              <?php echo form_open('Administration/churchvisitor'); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo form_input('purpose',null,' class="form-control" placeholder="" id="" required');?>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="inputEmail4" class="col-form-label">Official</label>
                                                                <?php echo form_input('official',null,' class="form-control" placeholder="" id="" required');?>
                                                            </div>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="card">
                                                  <div class="card-body" >
                                                    ...
                                                    <hr>
                                                     <table  id="churchvisitor_data" class="table table-bordered table-striped">
    ...
    <?php $this->load->view('components/ajax_administration/ajax_churchvisitor'); ?>
    <?php $this->load->view('components/modal_administration/modal_churchvisitor'); ?>
