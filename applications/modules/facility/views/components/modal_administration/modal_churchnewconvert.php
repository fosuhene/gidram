                             ...
                             <!--    <h5 class="">Tithes Details</h5> -->
                                ...
                                <div class="row">
                                       <div class="col-sm-12 col-xs-12">
                                              <form id="churchnewconvertform"  method="post">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo form_input(['type' => 'text', 'name' => 'NCname', 'id' => 'NCname', 'class' => 'form-control','required' => 'required', 'value' => set_value('')]);?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputEmail4" class="col-form-label">Contact</label>
                                                        <?php echo form_input('NCcontact',null,' class="form-control" placeholder="" id="NCcontact" required');?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputEmail4" class="col-form-label">Address</label>
                                                        <?php echo form_input('NCaddress',null,' class="form-control" placeholder="" id="NCaddress" required');?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputEmail4" class="col-form-label">Caretaker</label>
                                                        <?php echo form_input('NCcaretaker',null,' class="form-control" placeholder="" id="NCcaretaker" required');?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputEmail4" class="col-form-label">Official</label>
                                                        <?php echo form_input('NCofficial',null,' class="form-control" placeholder="" id="NCofficial" required');?>
                                                    </div>
