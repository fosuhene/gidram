...
Class TaxCompany extends MY_Controller{
...
public function  __construct(){
 ...
 public function index(){
    ...
    $data['subview'] = 'taxcompany/index';
    $this->load->view('taxcompany/index', $data);
   }
 }
 ...
 public function detail(){
    if ($this->ion_auth->logged_in()){
    $data['user_info'] =$this->ion_auth->user()->row();
    $data['subview'] = 'taxcompany/taxcompany_detail';
    $this->load->view('taxcompany/taxcompany_detail', $data);
   }
 }
