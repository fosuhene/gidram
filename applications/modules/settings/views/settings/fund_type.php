                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <?php echo validation_errors(); ?>
                                                              <?php echo form_open('Settings/fund_type'); ?>
                                                                 <div class="form-group ">
                                                                    <label for="" class="col-form-label">Fund Type</label>
                                                                 <?php echo form_input('fund_type',null,' class="form-control" placeholder="welfare" id="" required');?>
                                                                </div>
                                                                <div class="form-group ">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <hr>
                                                             <table  id="fundtype_data" class="table table-bordered table-striped">
...
<?php $this->load->view('components/ajax_settings/ajax_fundtype'); ?>
<?php $this->load->view('components/modal_settings/modal_fundtype'); ?>
