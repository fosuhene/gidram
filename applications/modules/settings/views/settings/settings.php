                                                            ...
                                                            <?php echo validation_errors(); ?>
                                                              <?php echo form_open('Settings/index'); ?>
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo form_input('offering_type',null,' class="form-control" placeholder="" id="" required');?>
                                                                </div>
                                                                <div class="form-group">
                                                                <label for="exampleInputEmail111">Description</label>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <hr>
                                                             <table  id="offeringtype_data" class="table table-bordered table-striped">
...
<?php $this->load->view('components/ajax_settings/ajax_offeringtypedata'); ?>
<?php $this->load->view('components/modal_settings/modal_offeringtype'); ?>
