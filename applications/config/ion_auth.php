...
$config['tables']['content_users']   = 'content_users';
...
$config['national_group']               = 'national';             // Default administrators group, use name
$config['regional_group']               = 'regional';             // Default administrators group, use name
$config['district_group']               = 'district';             // Default administrators group, use name
$config['community_group']               = 'community';             // Default administrators group, use name
$config['facility_group']               = 'facility';             // Default administrators group, use name
